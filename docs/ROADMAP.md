...
| RAGFlow (предложение клиенту) | ▪ маркер, без демо | внешн.: `infiniflow/ragflow` (Apache-2.0) | «тяжёлый» RAG (≥16 GB RAM) для клиентов с мощным железом / в контуре клиента — §5.8 |
