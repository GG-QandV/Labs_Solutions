## Проанализируй разбери и опиши логику

 для создания спеки и напиши промпт из разбора этой сессии: Итог
